...
PS. Need a new 3scale account with a new application (user_key)
...
<p align="center">
<img src="https://raw.githubusercontent.com/aelkz/3scale-camel-policy/https/_images/02.png" title="3scale sample backend" width="40%" height="40%" />
</p>

1.3 Define the policy chain as follows

<p align="center">
<img src="https://raw.githubusercontent.com/aelkz/3scale-camel-policy/https/_images/05.png" title="3scale policy chain" width="40%" height="40%" />
</p>

1.4 Add a new policy `camel-service` and configure it with your camel application (this proxy app)

<p align="center">
<img src="https://raw.githubusercontent.com/aelkz/3scale-camel-policy/https/_images/01.png" title="3scale policy: camel service" width="40%" height="40%" />
</p>

*PS*. ON `https_proxy` ATTRIBUTE YOU MUST USE *HTTP* SCHEMA NOT HTTPS. USE PORT 8443 (RECOMENDED)
...
<p align="center">
<img src="https://raw.githubusercontent.com/aelkz/3scale-camel-policy/https/_images/04.png" title="3scale policy: service ports" width="40%" height="40%" />
</p>

2.3 Set application policy environment variables as follows:

<p align="center">
<img src="https://raw.githubusercontent.com/aelkz/3scale-camel-policy/https/_images/03.png" title="3scale policy: environment variables" width="40%" height="40%" />
</p>
